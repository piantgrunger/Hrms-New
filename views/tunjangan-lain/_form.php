...
$data = ArrayHelper::map(\app\models\Tunjangan::find()->select(['id','nama'=>"concat(kode,' - ',nama)"])
->asArray()->all(), 'id', 'nama');
...
<div class="Tunjangan-lain-form">
 ...
 ?>
    ...
    <?= $form->field($model, 'id_tunjangan')->widget(Select2::classname(), [
    'data' => $data,
    'options' => [
